...
<!--        <transition>
            ...
            >
                ...
                <div>
                    ...
                    >
                    <img
                        class="hidden md:block md:max-w-xl xl:max-w-3xl mx-auto md:-mt-64 z-10"
                        :src="fotoDrago"
                        alt=""
                    >
                </div>
                ...
                >
                    <div
                        class="font-bold text-4xl text-center md:text-6xl punctuation -rotate-12 -mt-6 mb-20 xl:mb-32">
                        " L'Amore vince su tutto... "
                    </div>
                </div>
                <div
